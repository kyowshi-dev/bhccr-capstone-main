...
<head>
    ...
    <title>Access Denied - BHCIS Sta. Ana</title>
...
<body class="min-h-screen flex items-center justify-center">
    <div class="text-center max-w-md mx-auto p-8">
        <div class="mb-6">
            <i class="fa-solid fa-lock text-6xl" style="color: var(--amber);"></i>
        </div>
        <h1 class="font-display text-3xl font-semibold mb-2" style="color: var(--ink);">Access Denied</h1>
        <p class="text-base mb-6" style="color: var(--ink-muted);">You do not have permission to access this page. If you believe this is an error, please contact your administrator.</p>
