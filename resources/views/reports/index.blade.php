...
<div class="space-y-5 lg:space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-5">
        ...
        <a href="{{ route('reports.mch-epi-fp') }}"
           class="block p-5 lg:p-6 rounded-xl border transition-all duration-200 hover:shadow-md" style="background: var(--bg-surface); border-color: var(--border);">
            <h3 class="font-display font-semibold text-base mb-1" style="color: var(--ink);">Maternal, EPI &amp; Family Planning report</h3>
            <p class="text-sm" style="color: var(--ink-muted);">Combined program register: individual patients, service dates and accountable health workers.</p>
        </a>
    </div>
