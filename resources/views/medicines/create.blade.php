        ...
        <form action="{{ route('medicines.store') }}" method="POST" class="space-y-4">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="rounded border-border text-accent-blue focus:ring-accent-blue">
